...
<%--                <a href="/faq" class="nav-item nav-link">고객센터</a>--%>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">장민님</a>
                    <div class="dropdown-menu m-0">
                        <a href="/member-info" class="dropdown-item">내 정보</a>
                        <a href="/faq" class="dropdown-item">FAQ</a>
                        <a href="/log-out" class="dropdown-item">로그아웃</a>
                    </div>
                </div>
            </div>
            <a href="/login" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">로그인</a>
            <a href="/signup" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">회원가입</a>
        </div>
    </nav>
</div>
<!-- Navbar & Hero End -->
